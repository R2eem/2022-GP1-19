...
//     progress.innerText=`${Math.ceil((count / 100) * 100)}%`+" Of 100 ";
//   }
//   if(count>100 && count<=1000){
//     progress.style.width=`${(count / 1000) * 100}%`;
//     progress.innerText=`${Math.ceil((count / 1000) * 100)}%` +" Of 1000 ";
//   }
//   if(count>1000 && count<=10000){
//     progress.style.width=`${(count / 10000) * 100}%`;
//     progress.innerText=`${Math.ceil((count / 10000) * 100)}%`+" Of 10000 ";
//   }
//   if(count> 10000 && count<=100000){
//     progress.style.width=`${(count / 100000) * 100}%`;
//     progress.innerText=`${Math.ceil((count / 100000) * 100)}%`+" Of 100000 ";
//   }
// }