...
class PharmcyNewOrdersPage extends StatefulWidget {

  const PharmcyNewOrdersPage();
  @override
  PharmcyNewOrders createState() => PharmcyNewOrders();
}

class PharmcyNewOrders extends State<PharmcyNewOrdersPage>with TickerProviderStateMixin {
                              ...
                              TabBar(onTap: (index){ //
                                setState(() {
                                  ...
                                  tabs: [
                                    ...
                                    Tab(icon: Text('Ready to pick up', style: TextStyle(fontFamily: "Lato", fontWeight: FontWeight.w700, fontSize: 17),),),
                                  ]),
                              Expanded(
